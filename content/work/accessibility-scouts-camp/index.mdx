...
workPageTitle: 'Accessibility Scouts Camp'
order: 13
metadata:
...
<ContentRowLast
    imageAlt={props.pageContext.frontmatter.workdetailwebsitelastcontentmainimagealt}
    heading={props.pageContext.frontmatter.workdetailwebsitelastheading}
    content={props.pageContext.frontmatter.workdetailwebsitelastcontent}
    contentAlt={props.pageContext.frontmatter.workdetailwebsitelastcontentmainimagealt}
    url={props.pageContext.frontmatter.workdetailwebsitelasturl}
    buttonContent={props.pageContext.frontmatter.workdetailwebsitesecondarybutton}
    className="last"
/>
