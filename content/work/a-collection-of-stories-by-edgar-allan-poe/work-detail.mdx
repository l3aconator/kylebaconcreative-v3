...
workPageTitle: 'A Collection of Short Stories by Edgar Allan Poe'
order: 12
metadata:
...
<WorkMiddle middlealt={props.pageContext.frontmatter.middlealt} />

<WorkSquareTall
    squarealt={props.pageContext.frontmatter.squarealt}
    tallalt={props.pageContext.frontmatter.tallalt}
    squareimagecaption={props.pageContext.frontmatter.squareimagecaption}
    tallimagecaption={props.pageContext.frontmatter.tallimagecaption}
/>

<WorkDetailFooter
    footeralt={props.pageContext.frontmatter.footeralt}
/>
