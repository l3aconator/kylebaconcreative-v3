...
workPageTitle: 'Kelley, Ink Website and Branding'
order: 19
metadata:
...
<WorkHeader
    ...
    heroimagealt={props.pageContext.frontmatter.heroimagealt}
    circleteaserone={props.pageContext.frontmatter.circleteaserone}
    circleteaseronealt={props.pageContext.frontmatter.circleteaseronealt}
    circleteasertwo={props.pageContext.frontmatter.circleteasertwo}
    circleteasertwoalt={props.pageContext.frontmatter.circleteasertwoalt}
>
...
<ExtrasRow colorpalette={props.pageContext.frontmatter.colorpalette} />

<ContentRowPrimary
    imageAlt={props.pageContext.frontmatter.workdetailwebsiteprimaryheroalt}
    heading={props.pageContext.frontmatter.workdetailwebsiteprimaryheading}
    content={props.pageContext.frontmatter.workdetailwebsiteprimarycontent}
    contentAlt={props.pageContext.frontmatter.workdetailwebsiteprimarycontentbgimagealt}
    url={props.pageContext.frontmatter.workdetailwebsiteprimaryurl}
    buttonContent={props.pageContext.frontmatter.workdetailwebsiteprimarybutton}
    className="primary"
/>

<ContentRowSecondary
    imageAlt={props.pageContext.frontmatter.workdetailwebsitesecondarycontentmainimagealt}
    heading={props.pageContext.frontmatter.workdetailwebsitesecondaryheading}
    content={props.pageContext.frontmatter.workdetailwebsitesecondarycontent}
    contentAlt={props.pageContext.frontmatter.workdetailwebsitesecondarycontentmainimagealt}
    url={props.pageContext.frontmatter.workdetailwebsitesecondaryurl}
    buttonContent={props.pageContext.frontmatter.workdetailwebsitesecondarybutton}
    className="secondary"
/>

<OffsetRow
    image={props.pageContext.frontmatter.workdetailwebsitetertiarycontentbgimage}
    imageAlt={props.pageContext.frontmatter.workdetailwebsitetertiarycontentbgimagealt}
    heading={props.pageContext.frontmatter.workdetailwebsitetertiaryheading}
    content={props.pageContext.frontmatter.workdetailwebsitetertiarycontent}
    className="tertiary"
/>

<FooterRow
    imageAlt={props.pageContext.frontmatter.workdetailwebsitefooterimagealt}
    heading={props.pageContext.frontmatter.workdetailwebsitefooterheading}
    content={props.pageContext.frontmatter.workdetailwebsitefootercontent}
/>

<IconRow
    heading={props.pageContext.frontmatter.workdetailiconographyheading}
    content={props.pageContext.frontmatter.workdetailiconographycontent}
    buttonContent={props.pageContext.frontmatter.workdetailiconographybutton}
    url={props.pageContext.frontmatter.workdetailiconographyurl}
/>
